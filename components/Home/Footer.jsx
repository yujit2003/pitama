        ...
        <div className="mk-page-section-inner relative mt-6">
            <div className="background-clipper">
                <div className="background-layer-holder">
                    <div className="relative h-[100vh] bg-[url('https://sundineproduce.com/wp-content/uploads/2019/03/sundine_produce_products_okra_bg2-1.jpg')] bg-cover bg-center bg-fixed w-full">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                                    ...
                                    <div>
                                        <div className="flex justify-center items-center mb-2 md:mb-0">
                                            <svg className="mk-svg-icon w-8" data-name="mk-moon-location-3" data-cacheid="icon-66af9f46174bd" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                    ...
                                    <div>
                                        <div className="flex justify-center items-center mb-2 md:mb-0">
                                            <svg className="mk-svg-icon w-8" data-name="mk-moon-phone-4" data-cacheid="icon-66af9f4617a2d" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                    ...
                                    <div>
                                        <div className="flex justify-center items-center mb-2 md:mb-0">
                                            <svg className="mk-svg-icon w-8" data-name="mk-li-mail" data-cacheid="icon-66af9f4617e85" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
