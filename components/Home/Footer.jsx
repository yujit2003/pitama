        ...
        <div className="mk-page-section-inner relative mt-6">
            <div className="background-clipper">
                <div className="background-layer-holder">
                    <div className="relative h-[100vh] bg-[url('https://eu-central.storage.cloudconvert.com/tasks/98e8eb86-7665-438d-94a6-239db45187b5/scrollHome.webp?X-Amz-Algorithm=AWS4-HMAC-SHA256&X-Amz-Content-Sha256=UNSIGNED-PAYLOAD&X-Amz-Credential=cloudconvert-production%2F20240821%2Ffra%2Fs3%2Faws4_request&X-Amz-Date=20240821T072333Z&X-Amz-Expires=86400&X-Amz-Signature=270fed0cf0c950faf010acd75c0d99140677f4fac87892c634e9766241d51ef6&X-Amz-SignedHeaders=host&response-content-disposition=inline%3B%20filename%3D%22scrollHome.webp%22&response-content-type=image%2Fwebp&x-id=GetObject')] bg-cover bg-center bg-fixed w-full">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                                    ...
                                    <div>
                                        <div className="flex justify-center items-center mb-2 md:mb-0">
                                            <svg className="mk-svg-icon w-8 pb-2" data-name="mk-moon-location-3" data-cacheid="icon-66af9f46174bd" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                    ...
                                    <div>
                                        <div className="flex justify-center items-center mb-2 md:mb-0">
                                            <svg className="mk-svg-icon w-8 pb-2" data-name="mk-moon-phone-4" data-cacheid="icon-66af9f4617a2d" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                    ...
                                    <div>
                                        <div className="flex justify-center items-center mb-2 md:mb-0">
                                            <svg className="mk-svg-icon w-8 pb-2" data-name="mk-li-mail" data-cacheid="icon-66af9f4617e85" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
